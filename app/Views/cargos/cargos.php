<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" href="<?php echo base_url('/css/cargos.css'); ?>">
...
<body>
    ...
    <div class="botn">
        <a href="" onclick="seleccionaCargo(<?php echo 1 . ',' . 1 ?>);" class="btn btn-success regresar_Btn"
            data-bs-toggle="modal" data-bs-target="#CargosModal">Agregar</a>
            <a href="<?php echo base_url('eliminados_cargos'); ?>" class="btn btn-secondary ">Eliminados</a>
            ...
            <tbody class="tbody">
                ...
                <tr>
                    ...
                    <td id="inp_edita" style="height:0.2rem;width:1rem;">
                        <input href="#" onclick="seleccionaCargo(<?php echo $dato['id'] . ',' . 2 ?>);"
                            data-bs-toggle="modal" data-bs-target="#CargosModal" type="image"
                            src="<?php echo base_url(); ?>/icons/escritura.png" width="16" height="16"
                            title="Editar Registro">
                        </input>
                    </td>
                    <td style="height:0.2rem;width:1rem;"><input href="#"
                            data-href="<?php echo base_url('/cargos/eliminar') . '/' .$dato['id']. '/' .'E'; ?>"
    ...
    <form method="POST" action="<?php echo base_url('/Cargos/insertar'); ?>" autocomplete="off">
        ...
        <div class="modal fade" id="CargosModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
function seleccionaCargo(id, tp) {
    if (tp == 2) {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(rs) {
                document.getElementById('exampleModalLabel').innerText = "Actualizar cargo";
                $("#tp").val(2);
                $("#id").val(id);
        ...
        $("#tp").val(1);
        document.getElementById('exampleModalLabel').innerText = "Agregar cargo";
        $("#nombre").val('');
